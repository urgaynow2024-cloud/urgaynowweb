...
export async function Footer() {
  ...
  return (
    <footer className="mt-20 border-t border-zinc-200/80 bg-gradient-to-b from-zinc-50 to-zinc-100 dark:border-zinc-800/80 dark:from-zinc-950 dark:to-zinc-900">
      <div className="bg-gradient-to-r from-brand-600 via-brand-700 to-brand-800 h-1 w-full" />
      <div className="mx-auto grid max-w-7xl gap-12 px-4 py-16 sm:grid-cols-2 lg:grid-cols-4">
        <div>
          <div className="flex items-center gap-2 text-xl font-extrabold text-brand-700 dark:text-brand-200">
            <span aria-hidden>🏳️‍🌈</span> Ur Gay Now
          </div>
          <p className="mt-4 max-w-xs text-base text-zinc-600 dark:text-zinc-400 leading-relaxed">
        ...
        <div>
          ...
          {socials.length > 0 ? (
            ...
            <p className="mt-4 text-base text-zinc-500">Social links coming soon.</p>
          )}
        </div>
      </div>

      <div className="border-t border-zinc-200/80 px-4 py-8 text-center text-base text-zinc-500 dark:border-zinc-800/80">
